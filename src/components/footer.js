...
export default function Footer() {
    return (<>
        ...
        <footer className="bg-neutral-900 text-center  text-white">
                    ...
                    <form action="">
                        <div
                            ...
                            <div className="relative md:mb-6 " data-te-input-wrapper-init>
                                <input
                                    type="text"
                                    className="peer block min-h-[auto] w-full rounded-lg  bg-transparent px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0 border-2 border-neutral-50"
                                    id="exampleFormControlInput1 border-white"
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4">
                    <div className="mb-6">
                        ...
                        <ul className="mb-0 list-none">
                            <li>
                                <Link legacyBehavior href="#!"><a  className="text-white">Link 1</a></Link>
                            </li>
                            <li>
            ...
            {/* <!-- Copyright section --> */}
            <div className="p-4 text-center bg-gray-700" >© 2023 Copyright: <a className="text-white" href="/"
            >GeekSewa</a
            >
            </div>
        </footer>
